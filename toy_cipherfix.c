...
int main()
{
    ...
    char result3[4];
    char result4[4];    
    secret_comp(p1, (char *)m, result1, result2, result3, result4);
    secret_comp(p2, (char *)m, result1, result2, result3, result4);
    ...
    printf("EOL\n");
    for (int i = 0; i < 4; ++i) printf("%d ", result2[i]);
    printf("EOL\n");
    for (int i = 0; i < 4; ++i) printf("%d ", result3[i]);
    printf("EOL\n");
    for (int i = 0; i < 4; ++i) printf("%d ", result4[i]);
    printf("EOL\n");
